    ...
    >
      <div className="w-full px-6 md:px-12 h-24 flex items-center justify-between">
        ...
        <button
          ...
          className={`flex items-center gap-3 cursor-pointer transition-colors duration-300 focus:outline-none ${isDarkTheme ? 'text-white' : 'text-neutral-950'}`}
          title="MAGINARI"
        >
          {/* Custom Architectural Empty Block Logoicon with Diagonal Slash */}
          <svg className="w-5.5 h-5.5 transition-transform duration-500 hover:rotate-90" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
            <rect x="3" y="3" width="18" height="18" />
            <path d="M3 3L21 21" strokeWidth="1.5" />
          </svg>
        </button>
